<template>
  <div class="home">
    <Header></Header>
    <span class="count" ><font color="#dc143c">共{{this.total}}篇
      标签：{{this.$route.query.tag}}</font></span>
            ...
            <el-row class="art-body">
              ...
              <div class="side-abstract">
                ...
                <div class="art-more">
                  ...
                  <div class="view"><i class="el-icon-view"></i>8888</div>
                </div>
              </div>
            </el-row>
          </el-card>
...
export default {
  ...
  methods: {
    page(currentPage) {
      const _this = this
      _this.$axios.get("/tag/" + _this.$route.query.tag+"?currentPage=" + currentPage).then(res => {
        console.log(res)
